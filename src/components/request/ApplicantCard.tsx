...
export default function ApplicantCard({
    ...
    return (
        <div
            onClick={review}
            className={`${user.portfolio?.reviewDate != null ? "bg-[#FFF4CF] " : "bg-[#E1E1E1]"} flex justify-center align-middle items-center p-3 cursor-pointer border-b border-gray-200 hover:bg-gray-50 transition`}
        >
